...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tap.beer'
        db.alter_column(u'taps_tap', 'beer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beers.Beer'], null=True))

    def backwards(self, orm):

        # Changing field 'Tap.beer'
        db.alter_column(u'taps_tap', 'beer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beers.Beer']))
    ...
    models = {
        ...
        u'taps.tap': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'beer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['beers.Beer']", 'null': 'True'}),
