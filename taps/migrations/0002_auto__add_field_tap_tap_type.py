...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tap.tap_type'
        db.add_column(u'taps_tap', 'tap_type',
                      self.gf('django.db.models.fields.CharField')(default='CO2', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tap.tap_type'
        db.delete_column(u'taps_tap', 'tap_type')
