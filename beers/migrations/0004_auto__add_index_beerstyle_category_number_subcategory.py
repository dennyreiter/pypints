...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'BeerStyle', fields ['category_number', 'subcategory']
        db.create_index(u'beers_beerstyle', ['category_number', 'subcategory'])


    def backwards(self, orm):
        # Removing index on 'BeerStyle', fields ['category_number', 'subcategory']
        db.delete_index(u'beers_beerstyle', ['category_number', 'subcategory'])
